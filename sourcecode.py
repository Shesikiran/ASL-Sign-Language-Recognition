...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr 27 19:17:20 2018
...
def read_dataset_ppm(rootpath, n_labels, resize_to):
  ...
  classes =['background','ben','mal']
  
  for c,s in enumerate(classes):
     full_path = rootpath + '/'  + s + '/'    
...
dataset = read_dataset_ppm('Midterm_Project_Data/train', N_CLASSES, RESIZED_IMAGE)
print(dataset.X.shape)
sprint(dataset.y.shape)
